...
export const processStep2Content=`We gather all the facts, and our scriptwriter writes the perfect script for the video. It is generally a story with your customer as the 'Hero.'`
...
export const processStep4Content=`Illustrators work their magic here to create apt characters, captivating visuals, and backgrounds based on the storyboard approved by the client. `
